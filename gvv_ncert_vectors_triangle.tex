...
\item Let 
\begin{align}
  \vec{A} &= \myvec{a_1\\a_2} \equiv a_1\overrightarrow{i}+a_2\overrightarrow{j}, 
  \\
  \vec{B} &= \myvec{b_1\\b_2}, 
\end{align}
be $2 \times 1$ vectors.
...
\begin{align}
  \label{eq:transpose3d}
  \vec{A}^{\top}  = \myvec{a_1 & a_2 & a_3}
\end{align}
%
...
\begin{align}
  ...
  &= \myvec{a_1 & a_2 & a_3} \myvec{b_1 \\ b_2 \\ b_3}= a_1b_1+a_2b_2 + a_3b_3
\end{align}
%
\item {\em norm} of $\vec{A}$ is defined as
\begin{align}
  \label{eq:norm3d}
  \norm{A} = \sqrt{\vec{A}^{\top} \vec{A}}= \sqrt{a_1^2+a_2^2+a_3^2}
\end{align}
