...
From \eqref{eq:conic_affine_norm_preserve}, we may consider the standard ellipse/hyperbola given by 
  ...
  \begin{align}
	...
	\vec{V} =     \vec{D} &= \myvec{\lambda_1 & 0 \\ 0 &\lambda_2}, f = -1, \vec{u} = 0, \vec{p}_1 = \vec{e}_1, \vec{p}_2 = \vec{e}_2
...
\end{align}  
	...
	The length of the latus rectum for an ellipse and hyperbola is given by
n be expressed as
