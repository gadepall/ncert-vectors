...
#if using termux
plt.savefig('/storage/emulated/0/github/school/ncert-vectors/defs/figs/cbse-10-4.pdf')
subprocess.run(shlex.split("termux-open /storage/emulated/0/github/school/ncert-vectors/defs/figs/cbse-10-4.pdf"))
#else
#plt.show()
